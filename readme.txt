...
productListFile.txt
	...
	At the end of each product line, discount number can be added to indicate the discount of a specific product. No discount number means the product does not have a special discount.